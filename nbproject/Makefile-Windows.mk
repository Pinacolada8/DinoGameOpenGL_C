...
${CND_DISTDIR}/${CND_CONF}/Start.exe: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/Start ${OBJECTFILES} ${LDLIBSOPTIONS} -Wall -g
...
${OBJECTDIR}/Game-SRC/Sounds.o: Game-SRC/Sounds.c
	${MKDIR} -p ${OBJECTDIR}/Game-SRC
	${RM} "$@.d"
	$(COMPILE.c) -g -IGameResources/Include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Game-SRC/Sounds.o Game-SRC/Sounds.c
