...
${OBJECTDIR}/Game-SRC/Cannon.o: Game-SRC/Cannon.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -IGameResources/Include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Game-SRC/Cannon.o Game-SRC/Cannon.c
...
${OBJECTDIR}/Game-SRC/Obstacles.o: Game-SRC/Obstacles.c
	${MKDIR} -p ${OBJECTDIR}/Game-SRC
	${RM} "$@.d"
	$(COMPILE.c) -O2 -IGameResources/Include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Game-SRC/Obstacles.o Game-SRC/Obstacles.c
...
${OBJECTDIR}/Game-SRC/PowerUp_invulnerability.o: Game-SRC/PowerUp_invulnerability.c
	${MKDIR} -p ${OBJECTDIR}/Game-SRC
	${RM} "$@.d"
	$(COMPILE.c) -O2 -IGameResources/Include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Game-SRC/PowerUp_invulnerability.o Game-SRC/PowerUp_invulnerability.c

${OBJECTDIR}/Game-SRC/Scenario.o: Game-SRC/Scenario.c
	${MKDIR} -p ${OBJECTDIR}/Game-SRC
	${RM} "$@.d"
	$(COMPILE.c) -O2 -IGameResources/Include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Game-SRC/Scenario.o Game-SRC/Scenario.c

${OBJECTDIR}/Game-SRC/Scores.o: Game-SRC/Scores.c
	${MKDIR} -p ${OBJECTDIR}/Game-SRC
	${RM} "$@.d"
	$(COMPILE.c) -O2 -IGameResources/Include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Game-SRC/Scores.o Game-SRC/Scores.c

${OBJECTDIR}/Game-SRC/Sounds.o: Game-SRC/Sounds.c
	${MKDIR} -p ${OBJECTDIR}/Game-SRC
	${RM} "$@.d"
	$(COMPILE.c) -O2 -IGameResources/Include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Game-SRC/Sounds.o Game-SRC/Sounds.c
